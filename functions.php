...
function dr_javier_scripts() {
    ...
    wp_enqueue_style(
        'google-fonts',
        'https://fonts.googleapis.com/css2?family=Bodoni+Moda:ital,opsz,wght@0,6..96,300;0,6..96,400;1,6..96,300;1,6..96,400&family=Italiana&family=Jost:wght@300;400;500&display=swap',
        false
    );
